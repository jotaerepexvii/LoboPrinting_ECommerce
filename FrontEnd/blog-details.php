                            ...
                            <div class="blog-details-top">
                                ...
                                <div class="blog-details-thumb-wrap">
                                    ...
                                    <div class="upcoming-date">
                                        8<span class="upc-mth">Mayo 2021</span>
                                    </div>
                                </div>
                                <!--End Blog Thumb -->
                                <h2>Lobo printing estrena su nuevo webpage.</h2>
                                <div class="blog-admin-and-comment">
                                    <p>Por : <a href="#">123456</a></p>
                                    <p class="separator">|</p>
                                    <p>3 COMMENTS</p>
                                </div>
                                <!-- Start Blog Pra
                                ...
                                <div class="our-reply-form-area mt--20">
                                    <div class="reply-form-inner mt--40">
                                        <div class="blog__details__btn">
                                            <a class="htc__btn btn--gray" href="index.php#Noticias">Volver</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Reply Form -->
