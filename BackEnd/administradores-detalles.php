                  ...
                  <form action='administradores-editar.php?admin_id={$row['product_id']}' method='post'>
                    ...
                    <div class='card-body'>
                        ...
                        <div class='form-group'>
                            ...
                            <input type='text' class='form-control' id='product_id' name='product_id' value='$row[admin_id]'>
                        </div>
                        <div class='form-group'>
                            <label for='exampleInputEmail1'>Email</label>
                            <input type='text' class='form-control' id='descripion' name='description' value='$row[email]'>
                        </div>
                    </div>
                    <!-- /.card-body -->
